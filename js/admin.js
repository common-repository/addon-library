...
function UniteAdminUC(){
	 ...
	 */
	this.arrCssToStrCss = function(arrCss, selector){
		...
		var strCss = selector += "{"+strContent+"}";
	...
	this.showSuccessMessage = function(htmlSuccess){
		...
		jQuery(id).show().html(htmlSuccess);
            ...
            var content ='<i class="fa fa-check-circle" aria-hidden="true" style="color: green;"></i><span>' + 'Saved Successfully' + '</span>';
