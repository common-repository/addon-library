function UniteCreatorParamsPanel(){
	...
	var g_objChildKeys = null, g_objTemplateCode = null;
	 ...
	 */
	function getTemplateCode(key, paramName){
	...
	function addImageParam(objParam, filter){
		...
		var isParamChild = (parentName != null);
	...
	function addParam(objParam, type, filter){
		...
		switch(originalName){
			case "no_items_code":
				...
				rawInsertText = getTemplateCode("no_items_code", childParamName);
			break;
		}
	 ...
	 * set thumb sizes
	 */
	this.initGlobalSetting_ChildKeys = function(objChildKeys){
